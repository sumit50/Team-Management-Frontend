...
const activeLink = "bg-green-600 text-white";
const inactiveLink = "text-gray-300 hover:bg-gray-800 hover:text-white";

// Sidebar links config (single source of truth)
const NAV_LINKS = [
  { to: "/lead/my-team", label: "Dashboard", end: true },
  { to: "/lead/team-members", label: "Team Members" },
  { to: "/lead/tasks", label: "Tasks" },
  { to: "/lead/change-password", label: "Change Password" },
];
...
const TeamLeaderSidebar = () => {
  ...
  return (
    <aside className="w-64 min-h-screen bg-black p-4 flex flex-col">
      ...
      <h1 className="text-xl font-bold text-white mb-8">Team Lead Panel</h1>
...
export default memo(TeamLeaderSidebar);
